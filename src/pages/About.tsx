        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="text-slate-600 leading-relaxed">
              Мы открыли свои двери в 2018 году с одной простой мечтой: создать детский центр, в который дети будут бежать с радостью, а родители — отдавать их со спокойным сердцем
            </p>
            <p className="text-slate-600 leading-relaxed">
              За 6 лет мы выросли из маленькой студии в полноценный центр развития с собственным мини-садом, соляной пещерой и более чем 15 направлениями обучения
            </p>
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="p-6 bg-brand-mint/10 rounded-3xl">
                <div className="text-3xl font-bold text-brand-mint mb-1">25+</div>
