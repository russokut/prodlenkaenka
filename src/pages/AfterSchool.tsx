      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          <div className="flex flex-col gap-8">
            <h2 className="text-3xl font-display font-bold text-slate-800">Что мы делаем на продленке?</h2>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -right-10 glass-card p-8 max-w-xs hidden md:block">
              ...
              <div className="text-3xl font-display font-bold text-slate-800">12:00 - 19:00</div>
              <div className="text-slate-500 text-sm mt-2">Забираем детей из школы по договоренности</div>
            </div>
          </div>
        </div>
