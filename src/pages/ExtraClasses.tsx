...
import { Languages, Brain, GraduationCap, CheckCircle2, ArrowRight } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-32">
          {classes.map((item, i) => (
            <div key={i} className="glass-card p-10 flex flex-col gap-8 hover:shadow-2xl transition-all group">
              ...
              <a 
                href={`https://wa.me/79282468732?text=Здравствуйте! Хочу записаться на занятие: ${item.title}`}
                target="_blank"
        ...
        <div className="bg-white rounded-[50px] p-12 md:p-20 shadow-xl overflow-hidden relative">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="rounded-[40px] overflow-hidden shadow-2xl">
              <img 
                src="https://picsum.photos/seed/classes/800/800" 
                alt="Занятия" 
