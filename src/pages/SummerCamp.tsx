          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div className="bg-white rounded-[40px] p-10 text-slate-800 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <div className="text-slate-400 text-sm mt-1">за 2 недели (10 рабочих дней)</div>
              </div>
              ...
              <a 
                href="https://wa.me/79282468732?text=Здравствуйте! Хочу забронировать место в летнем клубе"
                target="_blank"
                rel="noopener noreferrer"
