      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-32">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { time: '09:00 - 09:30', title: 'Прием детей', icon: Sun },
              { time: '09:30 - 09:50', title: 'Зарядка', icon: Heart },
              { time: '10:00 - 10:30', title: 'Развитие речи', icon: Users },
              { time: '11:00 - 11:15', title: 'Перекус', icon: Utensils },
              { time: '11:15 - 11:45', title: 'ИЗО-лепка', icon: Heart },
              { time: '12:00 - 13:00', title: 'Свободная игра', icon: Clock },
            ].map((item, i) => (
